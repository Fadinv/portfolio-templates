    ...
    return (
        <div style={{
                ...
                <div className={styles.InfoBar}>
                    ...
                    <div className={styles.SkillsBarWrapper}>
                        ...
                        <div className={styles.SkillsBar}>
                            ...
                            <div><span className={styles.Skill}>vue.js</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className={styles.PortfolioStuck}>
                ...
                <Templates>
                    <TemplatesItem src={'/cdlook.jpg'} href={'https://cdl-rho.vercel.app/'}
                                   github={'https://github.com/Fadinv/cdl'}
                                   description/>
                </Templates>
            ...
            <div className={styles.PortfolioStuck}>
                ...
                <Templates>
                    <TemplatesItem src={'/game1.jpg'} href={'https://clicker-blond.vercel.app/'}
                                   ...
                                   ps={'Ps. Фоновую музыку я написал сам, поэтому дал вам возможность ее отключить :)'}/>
            ...
            <div className={styles.PortfolioStuck}>
                ...
                <Templates>
                    <TemplatesItem src={'/docker1.png'} href={'https://github.com/Fadinv/docker/'}
