        ...
        return (
            <div className={styles.ImageStuck}>
                <div id={'key0'} className={styles.ImageBox + ' ' + styles.active}>
                    <img alt={''} className={styles.ImageItem} src={'/land2/IMaGf.png'}/>
                </div>
                <div id={'key1'} className={styles.ImageBox}>
                    <img alt={''} className={styles.ImageItem} src={'/land2/germanpassiv2.png'}/>
                </div>
                <div id={'key2'} className={styles.ImageBox}>
                    <img alt={''} className={styles.ImageItem} src={'/land2/hold.png'}/>
                </div>

                <div className={styles.StuckButtons}>
                    <button className={styles.Button + ' ' + styles.activeButton} onClick={this.toggleImage.bind(this)}
                            data-key={'key0'} key={'0'}/>
                    <button className={styles.Button} onClick={this.toggleImage.bind(this)} data-key={'key1'}
                            key={'1'}/>
                    <button className={styles.Button} onClick={this.toggleImage.bind(this)} data-key={'key2'}
                            key={'2'}/>
                </div>
            </div>
        )
